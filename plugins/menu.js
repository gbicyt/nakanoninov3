...
m.reply(wait)
  try {
    ...
    let url = 'https://telegra.ph/file/606c5429508ed833177db.jpg'
    conn.sendButton(m.chat,
`Nakano Ninoラ | By Dims

${wish()} ${name}
`, text.trim(), `https://telegra.ph/file/606c5429508ed833177db.jpg`, [
...
contextInfo: { externalAdReply :{
                        ...
                        description: 'anu',
                        title: bottime,
                        body: 'Nakano Ninoラ V.3',          previewType: 0,
...
handler.command = /^(allmenu|menuu)$/i
